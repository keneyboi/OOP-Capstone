...
Constructor public Equation(String t) -> sets Type to t & Result to 0;
...
Constructor public Combination(double n, double r) -> calls parent constructor;
...
Constructor public Permutation(double n, double r) -> calls parent constructor;
...
Constructor public Bernoulli(double n, double k, double q, double p) -> calls parent constructor;
...
Constructor public Hypergeometric(double n, double k, double r, double m) -> calls parent constructor;
...
Constructor public DiscreteCalculator();
...
Constructor public BackgroundPanel(String ImagePath);
